/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 64c3474a10f5aa8cb02e65a3f76eb071)
// Runtime types generated with workerd@1.20260312.1 2026-03-14 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		KV: KVNamespace;
		AI: Ai;
		MIXI2_CLIENT_ID: string;
		MIXI2_CLIENT_SECRET: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MIXI2_CLIENT_ID" | "MIXI2_CLIENT_SECRET">> {}
}
